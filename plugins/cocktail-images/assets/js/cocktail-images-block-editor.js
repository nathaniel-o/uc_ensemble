...
(function() {
    ...
    wp.domReady(function() {
        ...
        // Add custom attribute to image blocks
        addFilter(
        ...
        const withCocktailImageControls = createHigherOrderComponent(function(BlockEdit) {
            return function(props) {
                ...
                const { cocktailPopOut } = attributes;
        ...
        // Add custom class to image blocks when pop out is enabled
        addFilter(
            'blocks.getSaveContent.extraProps',
            'cocktail-images/image-block-save-props',
            function(props, blockType, attributes) {
                if (blockType.name === 'core/image' && attributes.cocktailPopOut) {
                    return {
                        ...props,
                        className: props.className ? 
                            props.className + ' cocktail-pop-out' : 
                            'cocktail-pop-out'
                    };
                }
                return props;
